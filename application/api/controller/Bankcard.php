...
class Bankcard extends Online
{
    ...
    public function index(){
        ...
        if(request()->isPost()){
            ...
            if($card_data['cardtype']=='借记卡'){
                $card_pic_type='DEBIT';
            }elseif($card_data['cardtype']=='信用卡'){
            ...
            $card_id=preg_replace('# #', '', $card_data['cardnumber']);//银行卡
            ...
            $model['bank_name']=$card_data['cardname'];
