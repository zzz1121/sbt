...
<form id="pageListForm">
    <div class="layui-form">
        <table class="layui-table mt10" lay-even="" lay-skin="row">
            ...
            <tr>
                <td><input type="checkbox" name="ids[]" class="layui-checkbox checkbox-ids" value="<?php echo $vo['ids']; ?>" lay-skin="primary"></td>
                <td class="font12">
                    <p class="ml10 fl"><strong class="mcolor">
                        <?php if($vo['name']): ?>
                            <?php echo $vo['name']; else: ?>未认证<?php endif; ?>
                    </strong>
                        <br>手机：<?php echo $vo['user_id']; ?></p>
                </td>
                <td class="font12">
                    用户等级:签约代理商
                    <br>
                    下属商户数：<?php echo $vo['underling']+$vo['indirect']; ?></td>
                <td class="font12">余额：<?php echo $vo['balance']; ?>（元）<br>交易量：<?php echo $vo['integral']; ?>（元）</td>
                <td class="font12">直属商户：<?php echo $vo['underling']; ?><br>间接商户：<?php echo $vo['indirect']; ?></td>
                <td><input type="checkbox"  <?php if($vo['login_status'] == 1): ?>checked=""<?php endif; ?> value="<?php echo $vo['login_status']; ?>" lay-skin="switch" lay-filter="switchStatus" lay-text="正常|锁定" data-href="<?php echo url('status?table=user&ids='.$vo['merchant_id']); ?>"></td>
                <td>
                    <div class="layui-btn-group">
                        <div class="layui-btn-group">
                            <a href="<?php echo url('update?user_id='.$vo['user_id']); ?>" class="layui-btn layui-btn-primary layui-btn-small"><i class="layui-icon">&#xe642;</i></a>
                            <!--<a data-href="<?php echo url('edit?merchant_id='.$vo['merchant_id']); ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-del"><i class="layui-icon">&#xe640;</i></a>
							-->
						</div>
                    </div>
                </td>
