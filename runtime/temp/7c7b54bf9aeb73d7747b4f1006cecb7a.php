...
<div class="layui-tab-content page-tab-content">
    <div class="layui-tab-item layui-show">
            ...
            <div class="page-filter fr">
                <form class="layui-form layui-form-pane" action="<?php echo url(); ?>" method="get">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline layui-select">
                            <select name="up_role" class="field-type" type="select"
                                data-href="<?php echo url('audit'); ?>"  lay-filter="up_role_id" >
                                ...
                                <option value="<?php echo $v['role_id']; ?>" <?php if($v['role_id'] == $up_role): ?>selected=selected<?php endif; ?> ><?php echo $v['role_name']; ?></option>
                    ...
                    <div class="layui-form-item">
                        ...
                        <a data-href="<?php echo url('up_level?up_role='.$up_role); ?>"  data-form="#pageListForm"
        ...
        <p>当前升级条件：</p>
        <?php switch($upgrade['upgrade_type']): case "1": ?>推广人数:<?php echo $upgrade['referrer_count']; ?>人  &&  最近<?php echo $upgrade['period']; ?>天：日流水金额:<?php echo $upgrade['integral']; ?>元<?php break; case "2": ?>最近<?php echo $upgrade['period']; ?>天：日流水金额:<?php echo $upgrade['integral']; ?>元<?php break; case "3": ?>推广人数:<?php echo $upgrade['referrer_count']; ?>人<?php break; endswitch; ?>
        <form id="pageListForm">
            <div class="layui-form">
                <table class="layui-table mt10" lay-even="" lay-skin="row">
                    ...
                    <tr>
                        <td><input type="checkbox" name="ids[]" value="<?php echo $vo['ids']; ?>" class="layui-checkbox checkbox-ids" lay-skin="primary"><div class="layui-unselect layui-form-checkbox" lay-skin="primary"><i class="layui-icon"></i></div></td>
                        <td><?php echo $vo['user_id']; ?></td>
                        <td><?php echo $vo['name']; ?></td>
                        <td><?php echo $vo['role_name']; ?></td>
                        <td><?php echo $vo['underling']; ?></td>
                        <td><?php echo $vo['indirect']; ?></td>
                        ...
                        <td>
                            <div class="layui-btn-group">
                                <div class="layui-btn-group">
                                    <a data-href="<?php echo url('up_level'); ?>?ids=<?php echo $vo['ids']; ?>&up_role=<?php echo $up_role; ?>" class="layui-btn layui-btn-primary layui-btn-small j-tr-up-lv"><i class="layui-icon">&#xe619;</i></a>
